...
public class ApiConnectionIT {
    ...
    @Test
    public void getAllSubmissionFromAssignmentGroupTest() {
        
        ApiConnection api = new ApiConnection(docker.getAuthUrl(), docker.getStuMgmtUrl());
        assertDoesNotThrow(() -> api.login("adam", "123456"));
        
        List<Assessment> assessments =  assertDoesNotThrow(() -> 
            api.getAllAssessmentsFromAssignment(courseId, new Assignment(
